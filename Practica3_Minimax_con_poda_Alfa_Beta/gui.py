...
class GameGUI:
    def __init__(self, root):
        ...
        self.agent = Agente(profundidad_maxima = 1)
    ...
    def setup_ui(self):
        ...
        ctk.CTkRadioButton(inner_panel,
                           ...
                           value=False,
                           font=ctk.CTkFont(size=13), fg_color="#f38ba8", hover_color="#f38ba8").pack(anchor="w", pady=5)

        ctk.CTkRadioButton(inner_panel, text="Minimax + Alfa-Beta", variable=self.use_alpha_beta, value=True,
                           font=ctk.CTkFont(size=13), fg_color="#89b4fa", hover_color="#89b4fa").pack(anchor="w", pady=5)
        ...
        ctk.CTkRadioButton(inner_panel, text="Humano", variable=self.ai_starts, value=False, font=ctk.CTkFont(size=13),
                           fg_color="#a6e3a1", hover_color="#a6e3a1").pack(anchor="w", pady=5)

        ctk.CTkRadioButton(inner_panel, text="IA (Máquina)", variable=self.ai_starts, value=True,
                           font=ctk.CTkFont(size=13), fg_color="#a6e3a1", hover_color="#a6e3a1").pack(anchor="w",
                                                                                                      pady=5)
        ...
        ctk.CTkLabel(table_frame, text="Métrica", font=ctk.CTkFont(size=13, weight="bold"), text_color="#a6adc8").grid(
            row=0, column=0, padx=15, pady=(8, 4), sticky="w")
        ctk.CTkLabel(table_frame, text="Valor", font=ctk.CTkFont(size=13, weight="bold"), text_color="#a6adc8").grid(
            row=0, column=1, padx=15, pady=(8, 4), sticky="e")
        ctk.CTkFrame(table_frame, height=1, fg_color="#313244").grid(row=1, column=0, columnspan=2, sticky="ew",
                                                                     padx=10, pady=(0, 5))

        ctk.CTkLabel(table_frame, text="Nodos", font=ctk.CTkFont(size=12)).grid(row=2, column=0, padx=15, pady=4,
                                                                                sticky="w")
        self.val_nodes = ctk.CTkLabel(table_frame, text="0", font=ctk.CTkFont(size=12, weight="bold"),
                                      text_color="#f9e2af")
        self.val_nodes.grid(row=2, column=1, padx=15, pady=4, sticky="e")

        ctk.CTkLabel(table_frame, text="Tiempo", font=ctk.CTkFont(size=12)).grid(row=3, column=0, padx=15, pady=4,
                                                                                 sticky="w")
        self.val_time = ctk.CTkLabel(table_frame, text="0.000 s", font=ctk.CTkFont(size=12, weight="bold"),
                                     text_color="#a6e3a1")
        self.val_time.grid(row=3, column=1, padx=15, pady=4, sticky="e")

        ctk.CTkLabel(table_frame, text="Memoria", font=ctk.CTkFont(size=12)).grid(row=4, column=0, padx=15, pady=(4, 8),
                                                                                  sticky="w")
        self.val_mem = ctk.CTkLabel(table_frame, text="0.00 KB", font=ctk.CTkFont(size=12, weight="bold"),
                                    text_color="#89dceb")
