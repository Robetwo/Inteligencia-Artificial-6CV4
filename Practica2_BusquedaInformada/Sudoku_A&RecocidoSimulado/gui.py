...
class ModernSudokuApp(ctk.CTk):
    ...
    def setup_ui(self):
        ...
        ctk.CTkLabel(self.sidebar,
                     text="SUDOKU",
                     font=ctk.CTkFont(size=32, weight="bold")).pack(pady=15)

        ctk.CTkLabel(self.sidebar,
                     text="IA",
                     text_color="yellow",
                     font=ctk.CTkFont(size=24, weight="bold")).pack(pady=0)
        ...
        self.lvl_btn = ctk.CTkSegmentedButton(self.sidebar,
        ...
        ctk.CTkLabel(self.sidebar, text="Algoritmo:", font=ctk.CTkFont(size=14, weight="bold")).pack(pady=20)
    ...
    def update_display(self, board=None):
        ...
        for r in range(9):
            ...
            for c in range(9):
                ...
                if (board is not None and self.current_board[r, c] == 0):
                    color = "#3498db"
                else:
                    color = "white"
    ...
    def run_ai(self):
        ...
        if "A*" in algo_name:
            ...
            # El Recocido Simulado usa una meta heurística probabilística
